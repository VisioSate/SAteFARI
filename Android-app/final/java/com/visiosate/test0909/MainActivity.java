...
public class MainActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    connect.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        connect.setVisibility(INVISIBLE); /* to prevent starting the next activity several times */
        ...
        final CountDownTimer controllerTimer = new CountDownTimer(2000, 100) {
  ...
  /**
   * sets up the mean to send the packages to the rasp3
   */
