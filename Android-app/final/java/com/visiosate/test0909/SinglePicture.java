...
/**
 * Shows every picture (or video) individually
 */
...
public class SinglePicture extends AppCompatActivity {
    ...
    private float x1,x2;
    String num; /* phone number for the MMS */
    static final int MIN_DISTANCE = 200; /* for the swipe function */
...
//            mvideoView.setPadding(50,50,0,0);
        ...
        /* send the MMS with the messaging app from the phone */
    ...
    /**
     * Implements the possibility to swipe in order to go from one picture to the other
     * @param event
     * @return
     */
    @Override
    ...
    /**
     * Checks the filetype of the file because we don't display videos and pictures the same way
    ...
    /**
     * Calls our quicksort function
     * @param inputArr contact list
     */
    ...
    /**
     * Exchange function to swap our contacts (name and number)
     * @param i the position of the first contact to swap
     * @param j the position of the second contact to swap
     */
